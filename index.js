...
require('./gingersketchy.js')
nocache('../gingersketchy.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./index.js')
...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	        ...
	        console.log(color(`\n${themeemoji} YT CHANNEL: gingersketchy`,'magenta'))
            console.log(color(`${themeemoji} GITHUB: GingerBreadSketchy `,'magenta'))
            console.log(color(`${themeemoji} INSTAGRAM: @ginger_sketchy `,'magenta'))
...
require('./gingersketchy')(XeonBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
...
console.log(anu)
//if (!XeonWlcm.includes(anu.id)) return
try {
